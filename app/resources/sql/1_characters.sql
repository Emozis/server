...
(3, 'Charlie', 'profile3.png', 'other', 'Curious', 'Wants to explore the world', 'A curious character who is always asking questions.', 'What are we going to discover today?', NOW(), NOW(), true, 20, 12, true, 1)
;