...
@handle_exceptions
async def create_relationship(relationship: RelationshipCreate, relationship_service: RelationshipServiceDep):
...
@handle_exceptions
async def get_relationships(relationship_service: RelationshipServiceDep):
...
@handle_exceptions
async def update_relationship(relationship_id: int, relationship: RelationshipUpdate, relationship_service: RelationshipServiceDep):
