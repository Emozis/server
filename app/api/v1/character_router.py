...
from app.schemas import CharacterCreate, CharacterUpdate, CharacterResponse, MessageResponse, ErrorResponse
...
@handle_exceptions
async def create_character(charater: CharacterCreate, user_id: CurrentUser, chararter_service: CharacterServiceDep) -> MessageResponse:
...
@handle_exceptions
async def get_character_by_id(chararter_id: int, chararter_service: CharacterServiceDep) -> CharacterResponse:
...
@handle_exceptions
async def update_character(character_id: int, character: CharacterUpdate, user_id: CurrentUser, chararter_service: CharacterServiceDep) -> MessageResponse:
...
async def deactive_character(character_id: int, user_id: CurrentUser, chararter_service: CharacterServiceDep) -> MessageResponse:
...
@handle_exceptions
async def delete_character(character_id: int, user_id: CurrentUser, chararter_service: CharacterServiceDep) -> MessageResponse:
